package com.otilm.csc.signing.configuration.loader;
...
import com.otilm.csc.configuration.keypools.KeyPoolProfilesConfiguration;
import com.otilm.csc.signing.configuration.*;
import com.otilm.csc.signing.filter.Worker;
import com.otilm.csc.utils.configuration.CscConfigurationBuilder;
import com.otilm.csc.utils.configuration.KeyPoolProfileBuilder;
...
import static com.otilm.csc.utils.assertions.CollectionAssertions.assertContainsExactlyInAnyOrder;
...
class WorkerConfigurationLoaderTest {
    ...
    void getWorkersValid() throws Exception {
        ...
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_validWorkers.yml");
    ...
    void getWorkersMissingName() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingName.yml");
    ...
    void getWorkersMissingId() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingId.yml");
    ...
    void getWorkersMissingCryptoToken() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingCryptoToken.yml");
    ...
    void getWorkersUnknownCryptoToken() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_unknownCryptoToken.yml");
    ...
    void getWorkersMissingSignatureQualifiers() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingSignatureQualifiers.yml");
    ...
    void getWorkersMissingSignatureFormat() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingSignatureFormat.yml");
    ...
    void getWorkersMissingConformanceLevel() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingConformanceLevel.yml");
    ...
    void getWorkersMissingSignaturePackaging() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingSignaturePackaging.yml");
    ...
    void getWorkersMissingSignatureAlgorithms() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_missingSignatureAlgorithms.yml");
    ...
    void constructorShouldFailWhenCryptoTokenMissingName() throws Exception {
        ...
        Executable cb = () -> createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_cryptoTokenMissingName.yml");
    ...
    void constructorShouldFailWhenCryptoTokenMissingId() throws Exception {
        // when
        Executable cb = () -> createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_cryptoTokenMissingId.yml");
    ...
    void constructorShouldFailWhenCryptoTokenReferencesUnknownKeyPoolProfile() throws Exception {
        ...
        File workersFile = copyResourceToFileSystem(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_unknownKeyPoolProfile.yml");
    ...
    void getWorkersShouldReturnRawSignerCapabilitiesWhenDocumentTypeIsRaw() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_rawSigner.yml");
        ...
        // RAW signer should have no document-specific capabilities (empty list)
    ...
    void getWorkersShouldFailWhenRawSignerMissingSignatureAlgorithms() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_rawSignerMissingAlgorithms.yml");
    ...
    void getWorkersShouldFailWhenInvalidSignatureFormat() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_invalidSignatureFormat.yml");
    ...
    void getWorkersShouldFailWhenInvalidConformanceLevel() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_invalidConformanceLevel.yml");
    ...
    void getWorkersShouldFailWhenInvalidSignaturePackaging() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_invalidSignaturePackaging.yml");
    ...
    void getWorkersShouldReturnEmptyListWhenNoSigners() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_emptySigners.yml");
    ...
    void getWorkersShouldHandleMultipleValidWorkers() throws Exception {
        // given
        workerConfigurationLoader = createLoader(
                "com/otilm/csc/signing/configuration/loader/WorkerConfigurationLoaderTest_multipleWorkers.yml");
        ...
        assertTrue(rawWorker.capabilities().documentTypes()
                            .contains(com.otilm.csc.signing.configuration.DocumentType.RAW));
    }
