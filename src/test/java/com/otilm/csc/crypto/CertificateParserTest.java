...
class CertificateParserTest {
    ...
    void parseDerEncodedCertificateSuccess() throws Exception {
        // given
        byte[] bytes = loadBytesFromResources("com/otilm/csc/crypto/CertificateParserTest.der");
    ...
    void parsePkcs7ChainSuccess() throws Exception {
        // given
        byte[] bytes = loadBytesFromResources("com/otilm/csc/crypto/CertificateParserTest.p7b");
